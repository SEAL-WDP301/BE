...
export async function bootstrap() {
  ...
  logger.log('info', `🚀 SEAL API running on http://localhost:${port}/${prefix}`, {
    context: 'Bootstrap',
  });
  logger.log('info', `📖 Swagger docs: http://localhost:${port}/${prefix}/docs`, {
    context: 'Bootstrap',
  });
  logger.log('info', `🌍 Environment: ${configService.get<string>('app.nodeEnv')}`, {
    context: 'Bootstrap',
  });
}
