...
export class SeedService {
  ...
  private async seedEvents(adminId: number) {
    ...
    const eventsData = [
      {
        ...
        description:
          "A 48-hour coding marathon focused on AI and Web3 technologies.",
        ...
        tracks: [
          ...
          },
          {
            ...
            description: "Create smart solutions using AI",
            maxTeams: 50,
            maxMembersPerTeam: 5,
          },
        ],
      ...
      },
      {
        ...
        description:
          "An intensive bootcamp focusing on disruptive technologies in multiple sectors.",
        ...
        tracks: [
          ...
          {
            name: "HealthTech",
            description: "Improving healthcare through tech",
            maxTeams: 30,
            maxMembersPerTeam: 4,
          },
          {
      ...
      },
      {
        ...
        description:
          "Celebrate the end of the year with creative game development and security challenges.",
        season: Season.Fall,
        year: 2024,
        status: EventStatus.closed,
      ...
      },
      {
        ...
        tracks: [
          {
            name: "Generative AI",
            description: "LLMs, Image generation, and beyond",
            maxTeams: 60,
            maxMembersPerTeam: 4,
          },
          {
            name: "Robotics",
            description: "Software for autonomous robots",
            maxTeams: 20,
            maxMembersPerTeam: 5,
          },
        ],
      ...
      },
      {
        ...
        tracks: [
          ...
          },
          {
            ...
            description: "Reinventing online shopping",
            maxTeams: 40,
            maxMembersPerTeam: 4,
          },
        ],
      ...
      },
      {
        ...
        description:
          "The ultimate challenge for enterprise solutions and mobile applications.",
        season: Season.Fall,
        year: 2025,
        status: EventStatus.closed,
        ...
        tracks: [
          ...
          {
            name: "Mobile Apps",
            description: "Consumer mobile experiences",
            maxTeams: 50,
            maxMembersPerTeam: 4,
          },
        ],
    ...
    console.log(
      "[Event] Successfully seeded 6 past events with tracks and rounds.",
    );
  }
}
