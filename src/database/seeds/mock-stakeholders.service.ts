...
export class MockStakeholdersService {
  ...
  async run() {
    ...
    const stakeholdersData = [
      {
        ...
        experience: "15 năm kinh nghiệm thiết kế hệ thống phân tán và Cloud Computing. Từng dẫn dắt nhiều dự án chuyển đổi số lớn cho các tập đoàn quốc tế.",
        achievements: "- Kiến trúc sư trưởng dự án AKA Bot\n- AWS Certified Solutions Architect Professional\n- Google Cloud Professional Architect",
      ...
      },
      {
        ...
        experience: "10 năm làm việc trong lĩnh vực phát triển sản phẩm công nghệ, đặc biệt là các ứng dụng giải trí và thanh toán trực tuyến.",
        achievements: "- Quản lý thành công 2 sản phẩm lọt top 10 App Store Việt Nam\n- Giải thưởng Product Manager of the year 2023",
      ...
      },
      {
        ...
        experience: "8 năm xây dựng các hệ thống Core Banking và E-Wallet chịu tải cao (High Concurrency).",
        achievements: "- Tối ưu hóa hệ thống xử lý giao dịch chịu tải lên đến 10,000 TPS\n- Tác giả của thư viện mã nguồn mở có 2000+ stars trên Github",
      ...
      },
      {
        ...
        experience: "12 năm kinh nghiệm trong lĩnh vực bảo mật thông tin, kiểm thử xâm nhập (PenTest) và rà soát lỗ hổng phần mềm.",
        achievements: "- Phát hiện hơn 50 lỗ hổng Zero-day\n- Top 100 Bug Bounty Hacker trên HackerOne",
      ...
      },
      {
        ...
        experience: "7 năm làm việc với Dữ liệu lớn (Big Data), Xây dựng các mô hình Recommendation System và AI dự đoán người dùng.",
        achievements: "- Tăng 25% tỷ lệ chuyển đổi (CR) nhờ mô hình gợi ý sản phẩm\n- Xuất bản 3 bài báo khoa học quốc tế về Machine Learning",
      ...
      },
      {
        ...
        experience: "9 năm nghiên cứu và triển khai các hệ thống Computer Vision, NLP phục vụ nhận diện khuôn mặt và trợ lý ảo tiếng Việt.",
        achievements: "- Xây dựng core AI cho hệ thống eKYC hàng đầu Việt Nam\n- Giải nhất cuộc thi AI Challenge 2021",
      ...
      },
      {
        ...
        experience: "6 năm lập trình Golang, Java, làm việc chuyên sâu với Microservices, Kafka, Redis và gRPC.",
        achievements: "- Tham gia xây dựng hệ thống Campaign có thể xử lý hàng triệu user cùng lúc vào các dịp Lễ Tết.",
      ...
      },
      {
        ...
        experience: "11 năm kinh nghiệm quản trị hạ tầng server, triển khai CI/CD pipelines và quản lý hệ thống Kubernetes.",
        achievements: "- Triển khai toàn bộ hạ tầng K8s nội bộ phục vụ hàng nghìn dự án lớn nhỏ\n- CKA & CKS Certified",
      ...
      },
      {
        ...
        jobTitle: "QA Manager",
        organization: "VNPAY",
        experience: "10 năm làm việc trong lĩnh vực Đảm bảo chất lượng (QA), chuyên gia về Automation Testing và Performance Testing.",
        achievements: "- Xây dựng Automation framework giúp giảm 60% thời gian Regression Test\n- Đạt chứng chỉ ISTQB Advanced Level",
      ...
      },
      {
        ...
        experience: "8 năm quản lý các dự án phần mềm theo mô hình Agile/Scrum. Chuyên gia tư vấn quy trình phát triển sản phẩm linh hoạt.",
        achievements: "- Transform thành công quy trình Agile cho 3 tập đoàn lớn\n- Professional Scrum Master II (PSM II)",
    ...
    for (const st of stakeholdersData) {
      const existing = await this.prisma.user.findUnique({ where: { email: st.email } });
      if (!existing) {
        ...
        count++;
        console.log(`[Stakeholder] Created: ${st.name} - ${st.jobTitle} at ${st.organization}`);
      } else {
        console.log(`[Stakeholder] Skipped: ${st.email} already exists.`);
      }
    }

    console.log(`--- Mock Stakeholders Seeding Completed: ${count} users created ---`);
  }
}
